package if_46_03_1_fitspace.fitspace.service;
...
public class BookingService {
    ...
    @Autowired
    private fitspace.fitspace_sports_venue_booking_website_backend.service.ValidationService validationService;

    @Transactional
    public BookingDataResponse create(fitspace.fitspace_sports_venue_booking_website_backend.entity.User user, Long venueId, BookingAddRequest request){
    ...
    @Transactional
    public List<BookingDataResponse> get(fitspace.fitspace_sports_venue_booking_website_backend.entity.User user) {
    ...
    @Transactional
    public void delete(fitspace.fitspace_sports_venue_booking_website_backend.entity.User user, Long bookingId) {
    ...
    @Transactional
    public BookingDataResponse updateStatus(fitspace.fitspace_sports_venue_booking_website_backend.entity.User user, Long bookingId, BookingUpdateStatusRequest request) {
        var book = bookingRepository.findByCustomerAndId(user,bookingId)
